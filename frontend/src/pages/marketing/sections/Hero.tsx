...
export function Hero() {
  return (
    <section className="bg-sidebar text-white">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-8 px-6 pt-20 pb-24 text-center">
        <h1 className="text-5xl leading-[1.05] font-black tracking-tight text-balance sm:text-6xl md:text-7xl">
