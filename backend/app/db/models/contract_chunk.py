...
class ContractChunk(UUIDPrimaryKeyMixin, Base):
    ...
    # Postgres-generated (STORED) tsvector for BM25-style lexical retrieval —
    # kept in sync by Postgres itself on every raw_text write, never by
    # application code. Powers the chatbot's hybrid retrieval (dense +
    # lexical, fused via RRF) — see services/retrieval.py and
    # docs/CHATBOT_INTEGRATION_PLAN.md §3.2.
